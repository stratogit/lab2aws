...
public class TCPEchoServer {
	...
	{ 
		...
		System.out.println("Connection from " +s.getInetAddress().getHostName() + " at :"+ s.getInetAddress().getHostAddress());
		//Set up streams 
		InputStream in = s.getInputStream(); 
		OutputStream out = s.getOutputStream();
		s.getOutputStream().write(("Hello: " + s.getInetAddress().getHostName()).getBytes());
